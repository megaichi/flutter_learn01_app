...
// class PageLearnStore extends StatelessWidget {
//   @override
...
//       ),
//       home: LearnTabStorePage(title: 'Learn Folder List'),
//     );
//   }
// }
...
///
/// ストアページ
/// ToDo: ストアページ、将来的に実装、4つだとはみ出るので表示方法要件等
///
class LearnTabStoreFolderList extends StatefulWidget {
  LearnTabStoreFolderList({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _LearnTabStoreFolderListState createState() => _LearnTabStoreFolderListState();
}

///
///
///
class _LearnTabStoreFolderListState extends State<LearnTabStoreFolderList> {
  ...
  Widget _buildBody(BuildContext context) {
    return Container(
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              Row(children: [Text("ストアタブ 販売コンテンツの表示、実装はまだ先")]),
              Row(children: [Text("+ ボタンは、無効")]),
//               StreamBuilder<QuerySnapshot>(
//                 stream: Folder.select(folderType: FolderType.User, orderByField: orderBySelectedValue),
