...
// class PageLearnShare extends StatelessWidget {
//   @override
...
//       ),
//       home: LearnTabSharePage(title: 'Learn Folder List'),
//     );
//   }
// }
...
///
///
class LearnTabShareFolderList extends StatefulWidget {
  LearnTabShareFolderList({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _LearnTabShareFolderListState createState() => _LearnTabShareFolderListState();
}

///
///
///
class _LearnTabShareFolderListState extends State<LearnTabShareFolderList> {
  ...
  Widget _buildBody(BuildContext context) {
    return Container(
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              Row(children: [Text("シェアタブ 未実装 取り込んだパターン")]),
              Row(children: [Text("Storeタブも追加予定だが、幅が足りない")]),
            ],
          ),
        ));
  }
